const milestones = [
  ...
  {
    company: "Flux & Flow AS (present)",
    description:
      "Independent consulting through my own firm since 2023 — continuing in aerospace with propellant systems and pump design before returning to parallel architecture, RTL, verification, and GPU compute in 2026.",
  },
]
